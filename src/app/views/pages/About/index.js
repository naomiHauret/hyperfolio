		...
		>
			<Exit easing="linear" time={50} css={{ opacity: 0 }}>
				<Enter
					...
					time={550}
					css={{
						transform: state.location.pathname === contactPageUrl ? "translateY(15%)" : "translateY(-15%)",
						opacity: 0,
						overflow: "hidden",
					}}
				>
					...
					>
						...
						<div class={cxs({ marginTop: ds.pxTo(15, ds.get("typo.pxFontSize.base"), "rem"), textAlign: "center" })}>
