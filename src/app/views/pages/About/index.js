...
export default  () => (state, actions) => {
	return <div key="page" oncreate={actions.setPageMetaData({
			...
			<Exit easing="linear" time={50} css={{ opacity: 0 }}>
				<Enter easing="ease-in-out" time={550} css={{ transform: state.location.previous || state.location.pathname === contactPageUrl ? "translateY(150px)" : "translateY(-150px)", opacity: 1, scrollBehavior: "auto" }}>
					<div class={cxs({
							minHeight: "100vh",
							display: "flex",
							flexDirection: "column",
